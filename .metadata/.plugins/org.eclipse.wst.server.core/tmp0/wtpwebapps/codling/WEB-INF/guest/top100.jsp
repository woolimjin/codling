	...
	<header>
		<div id="scroll-header">
			<div id="scroll-header-box">
				...
				<form id="scroll_searbox" name="scroll_search_Frm" action="search">
					<input type="text" id="scroll_search" name="search"
						class="searchbox" value="" placeholder="검색어를 입력하세요.">
				</form>
				<input type="submit" form="scroll_searbox" class="btn-search"
					value="" />


				<c:if test="${empty indiId && empty corpId}">
					<a href="login" id="login-btn"><button type="button"
							id="scroll-log" class="log">Login</button></a>
				</c:if>
		...
		<div id="default-header">
			<div id="login_header">
				...
				<c:if test="${empty indiId && empty corpId}">
					<a href="login" id="login-btn"><button type="button" id="log"
							class="log">Login</button></a>
				</c:if>
