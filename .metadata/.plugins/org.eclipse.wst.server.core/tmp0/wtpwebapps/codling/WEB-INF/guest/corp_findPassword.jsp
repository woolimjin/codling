...
<head>
    ...
    <link rel="stylesheet" href="css/corp_findPassword.css" type="text/css">
    <script src="jQuery/jquery-3.6.0.min.js"></script>
    <script src="jQuery/jquery-ui.min.js"></script>
    <script src="js/corp_findPassword.js"></script>
</head>
<body>
    <header>
        <div></div>
    ...
    <section>
        <article>
            <h1 class="title">기업회원 비밀번호 찾기</h1><hr>
            ...
            <div id="chk_email">
                <b>가입 시 입력한 기업정보를 입력해 주세요.</b>
                <form action="corp_findPassword" method="post" name="findEmailForm">
                    <div class="input">
                        <div class="item"><b>아이디</b></div>
                        <div class="item"><input name="id"></div>
                        <div class="item"></div>
